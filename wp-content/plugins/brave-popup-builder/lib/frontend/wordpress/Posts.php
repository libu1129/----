...
if ( ! class_exists( 'BravePop_Element_Posts' ) ) {
   ...
   class BravePop_Element_Posts {
      ...
      public function render_css() { 
         ...
         $elementInnerStyle = '#brave_popup_'.$this->popupID.'__step__'.$this->stepIndex.' #brave_element-'.$this->data->id.' .brave_element__styler{'. $fontSize . $postTextColor . $fontFamily.'}';
         ...
         $elementTitleStyle = '#brave_popup_'.$this->popupID.'__step__'.$this->stepIndex.' #brave_element-'.$this->data->id.' .brave_post h4 a{'. $postTitleColor .$titlefontFamily.'}';
      ...
      public function renderMeta($cats , $postID){
         ...
         if($displayDate || $displayCat){
            $metaHTML .=  '<div class="brave_post__meta">';
                        ...
                        $postHTML .=  '<div id="brave_post-'.$thepost->ID.'" class="brave_post '.$imageAlignLeftClass.' '.$noContentClass.'">';
                           ...
                           if($layout  !== 3) { 
                              ...
                              $postHTML .=  '<div class="brave_post__content_wrap">';
                                 $postHTML .=  '<div class="brave_post__title"><h4><a '.$newWindowHTML.' href="'.get_the_permalink($thepost->ID).'">'. get_the_title($thepost->ID) .'</a></h4></div>';
                                 ...
                                 $postHTML .= $displayButton  && $buttonText && ($layout===1 || $layout===2) ? '<div class="brave_post__readMore"><a>'.$buttonText.'</a></div>' : '';
      ...
      public function render( ) { 
         ...
         return '<div id="brave_element-'.$this->data->id.'" class="brave_element brave_element--posts">
