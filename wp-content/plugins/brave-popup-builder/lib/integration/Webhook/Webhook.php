...
if ( ! class_exists( 'BravePop_Webhook' ) ) {
   ...
   class BravePop_Webhook {
      ...
      public function post($url, $hooktype, $fieldSettings, $current_user, $visitor_country, $visitor_ip){
         ...
         $args = array(
            'method' => 'POST',
            'headers' => $hooktype === 'integromat' ? array(  'content-type' => 'application/json') : array(),
